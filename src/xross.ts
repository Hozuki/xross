...
export module xross {
    ...
    class Line2D implements IHashCodeProvider {
    ...
    class LineSegment2D implements IEquatable<LineSegment2D>, IHashCodeProvider {
    ...
    class FutureEvent implements IComparable<FutureEvent>, IHashCodeProvider {
